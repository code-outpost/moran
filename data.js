const allData = [
    '我对你的喜欢，却用友情开错了头。I like you, but start with friendship by mistake.',
    '我像个路人看你生活心酸，你的喜怒哀乐都不为我。I like a passer-by to see your life sad, your happiness, anger, sorrow and joy, are not because of me.',
    '不能放弃就继续喜欢吧，至少心不会动荡不安。Can not give up and continue to like it, at least the heart will not be turbulent.',
    '我永远是你的备胎。I will always be your spare.',
    '人家可能是享受被人追捧的感觉。People may enjoy being sought after.',
    '你给了她全部，可是她要的并不够。You gave her everything, but she did not want enough.',
    '爱能让你骄傲如烈日，也能让我卑微如尘土。Love can make you proud as the sun, and make me humble as the dust.',
    '他满眼真诚和泪花，换来的不过是一次次的玩弄。His eyes were full of sincerity and tears, in exchange for playing again and again.',
    '哪有人惦记你这么久的，只是换来换去没有目标，才又找到你。No one cares about you for so long, only in exchange for no goal, to find you again.',
    '如果不是真的喜欢，谁又会愿意当个舔狗吗？If not really like, who would like to be a licking dog?',
    '舔到最后，一无所有？没人发现他在越变越优秀吗？Lick till the end, nothing? No one noticed that he was getting better and better?',
    '很想和你在一起，你能给的，别人给不了的，我给你，并且不会再给第二个人。I really want to be with you, what you can give, and what other people can not give, I will give it to you, and I won’t give it to the second person.',
    '这个世界到底不浪漫到了什么程度，深情之人竟被称为舔狗。The world is not romantic to what extent, affectionate people are called licking dogs.',
    '你拼了命的想要融入她的世界，她的世界却没有你。You are desperate to integrate into her world, but her world does not have you.',
    '只要你对我说一句重新来过，那我们就在一起。As long as you say to me once again, we will be together.',
    '因为她还没结婚，所以我还想等等。Because she’s not married, so I want to wait.',
